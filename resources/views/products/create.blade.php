        ...
        <x-nav>
            <div class="product-form-container">
                <div class="form-header">
                    <h1 class="form-title">Add a product</h1>
                    <span class="form-subtitle">Orders placed across your store</span>
                </div>
                    ...
                    <div class="form-columns-container">
                        <div class="form-left-column">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_name" id="productName" value="{{ old('product_name') }}" class="form-control" placeholder="Write product name here" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="product_description" id="productDescription" class="form-control textarea-control" placeholder="Write Description here" required>{{ old('product_description') }}</textarea>
                                @error('product_description')<span class="error-message">{{ $message }}</span>@enderror
                            </div>

                            <div class="form-group">
                                <label class="form-label">Product Color</label>
                                <input type="text" name="product_color" id="productColor" value="{{ old('product_color') }}" class="form-control" placeholder="Enter product color">
                                @error('product_color')<span class="error-message">{{ $message }}</span>@enderror
                            </div>

                            <div class="form-group">
                                <label class="form-label">Product Link</label>
                                <input type="url" name="product_link" id="productLink" value="{{ old('product_link') }}" class="form-control" placeholder="Enter product URL">
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-input-container">
                                    ...
                                    <input type="file" name="product_image" id="mainImage" class="file-input" accept="image/*" required>
                                </div>
                        ...
                        <div class="form-right-column">
                            <div class="form-right-top">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-select" id="brandSelect">
                                        ...
                                        <input type="hidden" name="product_brand" id="brandInput" class="hidden-input">
                                    </div>
                            ...
                            <div class="form-right-bottom">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="product_price" id="productPrice" value="{{ old('product_price') }}" class="form-control" step="0.01" placeholder="0.00" required>
                                    @error('product_price')<span class="error-message">{{ $message }}</span>@enderror
                                </div>

                                <div class="form-group">
                                    <label class="form-label required">Quantity</label>
                                    <input type="number" name="product_qty" id="productQuantity" value="{{ old('product_qty') }}" class="form-control" placeholder="0" required>
                                    @error('product_qty')<span class="error-message">{{ $message }}</span>@enderror
                                </div>

                                <div class="form-checkbox-group">
                                    <label class="form-checkbox-label">
                                        <input type="checkbox" name="product_is_enable" id="productEnable" value="1" class="form-checkbox" {{ old('product_is_enable') ? 'checked' : '' }}>
                                        Enable
                                    </label>
                                </div>
                                ...
                                <div class="form-checkbox-group">
                                    <label class="form-checkbox-label">
                                        <input type="checkbox" name="product_comming_soon" id="productSoon" value="1" class="form-checkbox" {{ old('product_comming_soon') ? 'checked' : '' }}>
                                        Coming Soon
                                    </label>
                                </div>
                            </div>
